...
function, `withMainSerialExecutor`, that attempts[^1] to run all tasks spawned in an operation
...
[^1]: We say "attempts" because under the hood it relies on a global, mutable variable in the Swift
