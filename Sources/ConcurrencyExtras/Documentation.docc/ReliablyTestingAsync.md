...
Well, now we can thanks to the ``withMainSerialExecutor(operation:)-79jpc`` tool that ships with
...
> Quote from AsyncAlgorithms: _Testing is a critical area of focus for any package to make it 
